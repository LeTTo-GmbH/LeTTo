...
Besteht bereits eine lokale Installation auf einem Linux Server (idealerweise Ubuntu LTS oder Debian) dann kann direkt auf diesem Server eine dockerbasierte Installation vorgenommen und dabei die bestehenden Daten übernommen werden.
...
* Installation des Servers als Ubuntu LTS oder Debian System 
